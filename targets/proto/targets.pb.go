...
import (
	...
	proto4 "github.com/google/cloudprober/targets/file/proto"
...
var file_github_com_google_cloudprober_targets_proto_targets_proto_goTypes = []interface{}{
	...
	(*proto4.TargetsConf)(nil),              // 8: cloudprober.targets.file.TargetsConf
	(*proto3.GlobalOptions)(nil),            // 9: cloudprober.targets.gce.GlobalOptions
	(*proto5.Options)(nil),                  // 10: cloudprober.targets.lameduck.Options
}
